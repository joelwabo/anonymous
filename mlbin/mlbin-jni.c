...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_initUsb(JNIEnv*env, Jobject this)
{
	libusb_device **list;
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_freeUsb(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_fire(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_PiedPiper_InitUsb_moveDown(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_moveLeft(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_moveRight(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_moveUp(JNIEnv*env, Jobject this)
{
...
JNIEXPORT jint JNICALL Java_com_android_anonymous_InitUsb_stop(JNIEnv*env, Jobject this)
{
